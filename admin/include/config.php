...
class Config {
  ...
  public $blocklists = array(
    ...
    'bl_notrack_annoyance' => array(true, 'misc', 'NoTrack Annoyance'),
    ...
    'bl_quantum_abuse' => array(false, 'malware', 'Quantum Ad List'),
    'bl_quantum_ads' => array(false, 'advert', 'Quantum Simply Ads List'),
    'bl_quantum_full' => array(false, 'advert', 'Quantum Full List'),
    'bl_quantum_privacy' => array(false, 'tracker', 'Quantum Privacy List'),
    'bl_quantum_youtube' => array(false, 'advert', 'Quantum YouTube List'),
