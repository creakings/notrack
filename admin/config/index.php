...
echo '<a href="../upgrade.php"><img src="../svg/menu_upgrade.svg"><span><h6>Upgrade</h6></span></a>'.PHP_EOL;
echo '<a href="./dns.php"><img src="../svg/menu_dns.svg" alt=""><span><h6>DNS Server</h6></span></a>'.PHP_EOL;
echo '<a href="../dhcp.php"><img src="../svg/menu_dhcp.svg" alt=""><span><h6>DHCP Network</h6></span></a>'.PHP_EOL;
